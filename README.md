<h1 align="center">Olá, eu sou a Laís Alves Ferraz 👋</h1>
...
- 🎓 Estou no **2º semestre de Engenharia de Software** na **Unifran**
- 💼 Atuei por **4 anos na área administrativa**, e hoje estou em transição de carreira para a área de tecnologia
- 🔎 No momento estou **em busca de oportunidades** na área de TI (estágio ou primeiro emprego na área)
- 🌱 Atualmente estudando:
  - Design profissional para perfis (LinkedIn, GitHub).
  - Desenvolvimento Front-end para Web.
  - Algoritmos e Pensamento Computacional.
  - Modelagem de Banco de Dados.
- 💬 Tenho facilidade de comunicação e organização, habilidades desenvolvidas na minha experiência administrativa
- ⚡ Estou aberta a trocar experiências, aprender e colaborar em projetos
